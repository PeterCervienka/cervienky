				...
				<div className="col-md-12 col-md-offset-0">
					<ul className="timeline animate-box">
						<li className="animate-box">
							<div className="timeline-badge" style={{'background-image': 'url(images/first_contact_color.png)'}}></div>
						...
						<li className="timeline-inverted animate-box">
							<div className="timeline-badge" style={{'background-image': 'url(images/date_color.png)'}}></div>
							<div className="timeline-panel">
								<div className="timeline-heading">
						...
						<li className="animate-box">
							<div className="timeline-badge" style={{'background-image': 'url(images/house_color.png)'}}></div>
							<div className="timeline-panel">
								<div className="timeline-heading">
						...
						<li className="animate-box">
							<div className="timeline-badge" style={{'background-image': 'url(images/ring_color.png)'}}></div>
							<div className="timeline-panel">
								<div className="timeline-heading">
						...
						<li className="animate-box">
							<div className="timeline-badge" style={{'background-image': 'url(images/wedding_color.png)'}}></div>
							<div className="timeline-panel">
								<div className="timeline-heading">
								...
								<div class="timeline-body">
									<p>Ale to nieje koniec príbehu. Práve naopak. Po vyše 4 (väčšinou) nádherných rokoch sa konečne budeme volať rovnako a naša spoločná cesta pokračuje ďalej...</p>
								</div>
							</div>
						</li>
			    	</ul>
